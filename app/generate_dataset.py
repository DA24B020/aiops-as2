"""Deterministic synthetic spam/ham dataset (verbatim from the assignment spec)."""
import random
...
print(f"wrote spam_dataset.csv rows={len(rows)} spam={sum(1 for _, l in rows if l == 'spam')}")
